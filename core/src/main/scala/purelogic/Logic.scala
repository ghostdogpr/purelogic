...
object Logic {
  ...
  def simulateWith[W, S, R, E, A](using Abort[E])(mockState: S, mockEnv: R)(f: Logic[R, W, S, E, A]): A = {
  ...
  def simulate[W, S, R, E, A](using Reader[R], State[S], Abort[E])(f: Logic[R, W, S, E, A]): A =
